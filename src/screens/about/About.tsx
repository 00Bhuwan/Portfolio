    ...
    <div className="flex h-auto w-full items-center overflow-hidden text-primaryColor">
      <div className="w-full xl:w-2/3">
        ...
        <p className="pb-4 pl-10 text-lg">
          My name is <span className="text-lg text-themePrimaryColor">Bhuwan Joshi</span> and I am an intermediate
          experienced <span className="text-lg text-themePrimaryColor">Python Developer </span>
          with over 5 month of expertise in Python Programming , Application or Model using{' '}
          <span className="text-lg text-themePrimaryColor">
            Python , Numpy, Pandas, PyTorch And Machine Learning
          </span>{' '}
          technologies. Currently Developing and Evolving My Skills In Python
        </p>
        <p className="pb-4 pl-10 text-lg">
